...
import { Funko } from "../../../src/practica/classes/funko.js";
import { FunkoTypes } from "../../../src/practica/enums/funko_types.js";
import { FunkoGenres } from "../../../src/practica/enums/funko_genres.js";
      ...
      (_, response) => {
        if (response) {
          ...
          expect(response.body.error).to.be.equal(
            "El Funko ya existe en la colección de test"
          );
        }
      }
    );
    ...
    request.post(
      ...
      (_, response) => {
        if (response) {
          expect(response.statusCode).to.be.equal(500);
          expect(response.body.error).to.be.equal(
            "El formato del Funko es incorrecto"
          );
          done();
        }
      }
    ...
    request.patch(
      ...
      (_, response) => {
        if (response) {
          ...
          expect(response.body.success).to.be.true;
          expect(response.body.message).to.be.equal(
            "Funko actualizado en la colección de test"
          );
          done();
        }
      }
    ...
    request.patch(
      ...
      (_, response) => {
        if (response) {
          expect(response.statusCode).to.be.equal(500);
          expect(response.body.error).to.be.equal(
            "El Funko no existe en la colección de test"
          );
        }
      }
    );
    ...
    request.patch(
      ...
      (_, response) => {
        if (response) {
          expect(response.statusCode).to.be.equal(500);
          expect(response.body.error).to.be.equal(
            "La colección del usuario test0 no existe"
          );
        }
      }
    );
    ...
    request(
      ...
      (_, response) => {
        if (response) {
          expect(response.statusCode).to.be.equal(500);
          expect(response.body.error).to.be.equal(
            "No existe el Funko con ID 2 en la colección del usuario test"
          );
        }
      }
    );
    ...
    request.delete(
      ...
      (_, response) => {
        if (response) {
          expect(response.statusCode).to.be.equal(500);
          expect(response.body.error).to.be.equal(
            "Este Funko no existe en la colección de test"
          );
        }
      }
    );
